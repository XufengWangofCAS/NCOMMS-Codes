...
SOS_R2_infile = '../NCOMMS-19-00016-T-SourceDataFile/FigureS11.data.SOS_vs_env_R2_P_latitude_sorted.xlsx'
EOS_R2_infile = '../NCOMMS-19-00016-T-SourceDataFile/FigureS12.data.EOS_vs_env_R2_P_latitude_sorted.xlsx'

SOS_R2 = pd.read_excel(SOS_R2_infile,'FigureS11')
EOS_R2 = pd.read_excel(EOS_R2_infile,'FigureS12')
...
out_fig_SOS='output_figures/FigS11_SOS_R2_season20190302_lat_sorted_disp_sig.png'  
...
out_fig_EOS='output_figures/FigS12_EOS_R2_season20190302_lat_sorted_disp_sig.png'  
