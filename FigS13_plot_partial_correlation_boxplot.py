...
infile = "../NCOMMS-19-00016-T-SourceDataFile/FigureS13.data_allsites_Pcor_SOS_cor_season.xlsx"

envir_SOS_data = pd.read_excel(infile,'FigureS13a')
envir_EOS_data = pd.read_excel(infile,'FigureS13b')
...
plt.savefig('output_figures/FigS13_partial_cor_FLX_phen_envir_CC_with_yerr.png',format='png',dpi=300,bbox_inches='tight')
plt.show()
