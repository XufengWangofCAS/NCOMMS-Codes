...
infile_envir = '../NCOMMS-19-00016-T-SourceDataFile/FigureS17_data.xlsx'

envir_SOS_data_group1 = pd.read_excel(infile_envir,'FigureS17a')
envir_SOS_data_group2 = pd.read_excel(infile_envir,'FigureS17b')
envir_EOS_data_group1 = pd.read_excel(infile_envir,'FigureS17c')
envir_EOS_data_group2 = pd.read_excel(infile_envir,'FigureS17d')
...
plt.savefig('output_figures/FigS17_species_FLX_phen_envir_CC_with_yerr.png',format='png',dpi=300,bbox_inches='tight')
plt.show()
