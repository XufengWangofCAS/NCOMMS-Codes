...
SOS_R2_P_infile = '../NCOMMS-19-00016-T-SourceDataFile/FigureS18_data.xlsx'
EOS_R2_P_infile = '../NCOMMS-19-00016-T-SourceDataFile/FigureS19_data.xlsx'


SOS_R2 = pd.read_excel(SOS_R2_P_infile,'FigureS18')
EOS_R2 = pd.read_excel(EOS_R2_P_infile,'FigureS19')
...
out_fig_SOS='output_figures/FigS18_SOS_carbonflux_R_season20190305_latitude_sorted_disp_Sig.png'  
...
plt.subplots_adjust(left=0.05, bottom=0.05, top=0.95, right=0.95, wspace=0, hspace=0)  
plt.legend(bbox_to_anchor=(0.7, 1.04), frameon=False, prop = font_tick, handlelength=2, ncol=4) 
out_fig_EOS='output_figures/FigS19_EOS_carbonflux_R_season20190305_latitude_sorted_disp_Sig.png'  
