...
sensitivity_file = '../NCOMMS-19-00016-T-SourceDataFile/FigureS6.data.xlsx'

sensitivity_data_SOS = pd.read_excel(sensitivity_file,"FigureS6a")
sensitivity_data_EOS = pd.read_excel(sensitivity_file,"FigureS6b")
sensitivity_data_spr = pd.read_excel(sensitivity_file,"FigureS6c")
sensitivity_data_aut = pd.read_excel(sensitivity_file,"FigureS6d")
sensitivity_data_yr = pd.read_excel(sensitivity_file,"FigureS6e")
...
plt.savefig('output_figures/FigS6_wh_sensitivity_ok.png',format='png',dpi=300,bbox_inches='tight')
plt.show()