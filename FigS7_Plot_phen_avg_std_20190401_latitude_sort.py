...
infile = '../NCOMMS-19-00016-T-SourceDataFile/FigureS7.data.xlsx'

data = pd.read_excel(infile,'FigureS7')
...
outfig_file = 'output_figures/FigS7_SOS_EOS_result20171023_latitude_sort.png'
plt.savefig(outfig_file,format='png',dpi=300,bbox_inches='tight')
plt.show()
