...
infile = '../NCOMMS-19-00016-T-SourceDataFile/Supplementary_Figure_14_RS_phenology_at_flux_sites.xlsx'        

data_SOS = pd.read_excel(infile,'FigureS14a')
data_EOS = pd.read_excel(infile,'FigureS14b')
...
plt.savefig('output_figures/FigS14_flxsites_gimms_phen_trend.png',format='png',dpi=300,bbox_inches='tight')
plt.show()
