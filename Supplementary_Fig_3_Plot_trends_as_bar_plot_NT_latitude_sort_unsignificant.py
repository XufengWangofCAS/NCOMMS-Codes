...
infile = '../NCOMMS-19-00016-T-SourceDataFile/Supplementary_Figure_3_flux_SOS_EOS_trend_site_data.xlsx'

data = pd.read_excel(infile,'FigureS3')
...
outfig_file = 'output_figures/FigS3_SOS_EOS_MK_%s_trend20181009_latitude_sort.png' %(method)
